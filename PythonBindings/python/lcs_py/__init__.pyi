...
class NewtonSolver:
    ...
    def update_per_vertex_animation(self, mesh_idx: int, local_vid: int, target_pos: numpy.ndarray[numpy.float32]) -> None:
        ...
        """
class SceneParams:
    collision_detection_frequece: int
    contact_energy_type: int
    current_frame: int
    d_hat: float
    damping_rate: float
    explicit_dt: float
    ...
    gravity: Float3
    implicit_dt: float
    nonlinear_iter_count: int
    output_per_frame: bool
    output_per_iteration: bool
    pcg_iter_count: int
    print_collision_info: bool
    print_pcg_info: bool
    print_system_energy: bool
    scene_id: int
    stiffness_bending_ui: float
    stiffness_collision: float
    stiffness_dirichlet: float
    use_ccd_linesearch: bool
    use_energy_linesearch: bool
    use_floor: bool
    use_gpu: bool
    ...
    def update_dt(self, dt: float) -> None:
        ...
        """
    @property
    def current_nonlinear_iter(self) -> int:
        ...
    @property
    def current_pcg_it(self) -> int:
        ...
    @property
