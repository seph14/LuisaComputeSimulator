...
#include <CollisionDetector/libuipc/distance/point_point.h>
#include <CollisionDetector/libuipc/distance/point_edge.h>
#include <CollisionDetector/libuipc/distance/point_triangle.h>
#include <CollisionDetector/libuipc/distance/edge_edge.h>
...
namespace uipc::backend::cuda::distance
{
	...
	namespace detail
	{
		...
		template <int N>
		inline IndexT active_count(const Vector<IndexT, N>& flag)
		{
			IndexT count = 0;
#pragma unroll
