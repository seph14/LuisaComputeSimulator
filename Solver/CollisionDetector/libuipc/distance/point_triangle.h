...
{
	template <class T>
	void point_triangle_distance2(const Eigen::Vector<T, 3>& p,
	...
	template <class T>
	void point_triangle_distance2_gradient(const Eigen::Vector<T, 3>& p,
		const Eigen::Vector<T, 3>&									  t0,
		const Eigen::Vector<T, 3>&									  t1,
		const Eigen::Vector<T, 3>&									  t2,
	...
	template <class T>
	void point_triangle_distance2_hessian(const Eigen::Vector<T, 3>& p,
		const Eigen::Vector<T, 3>&									 t0,
		const Eigen::Vector<T, 3>&									 t1,
		const Eigen::Vector<T, 3>&									 t2,
